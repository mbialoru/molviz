...
inline constexpr std::string_view git_sha{ "3a96a19716a3bb0eabfe379cd28cc171818184a7" };
inline constexpr std::string_view GIT_BRANCH{ "main" };
inline constexpr std::string_view GIT_SHORT_SHA{ "3a96a197" };
...
inline constexpr std::string_view BUILD_DATE{ "2023-12-14 21:52:13 UTC" };
